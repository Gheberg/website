...
<div class="tail-top">
    ...
    <h6>Commande enregistrée </h6>
	<br>
<table><tr><td><img src="images/accepter-check-ok-oui-icone-4851-32.png"></td><td>Votre commande a bien été enregistré, vous pouvez vous connecter dès maintenant sur votre compte pour suivre son avancement.</td></tr></table>
                        <br class="clear" />
                    </div>
                </div>
            </div>	 
