...
//MUMBLE RENOUVELLEMENT
$jexpire = $ancien_mois[0];
$mexpire = $nouveau_mois;
$addition = $jexpire + $mexpire;
if ($p == "mb1") $mumble = file_get_contents('http://mumble.gheberg.eu/mumble/mumble/renew.php?jour_expire='.$jexpire.'&mois_expire='.$mexpire.'&tocken=125Hksi7ji9J90l4vBCSsJ3'.$addition.'&pseudo='.$pseudo);
