...
if ($_GET['upgrade'] == "ok")
{
	$requeteupgrade=mysql_db_query($sql_bdd,"UPDATE heberg_membres set produit='vps1' where idd='$idd'",$db_link) or die(mysql_error());
}
...
if ($p == "vps2") {$tarif = 4.5;$allopass = 4;}
if ($p == "vps3") {$tarif = 9.5;$allopass = 9;}
if ($p == "vps4") {$tarif = 13;$allopass = 13;}
if ($p == "vps5") {$tarif = 17.5;$allopass = 16;}
if ($p == "vps6") {$tarif = 22.99;$allopass = 22;}
if ($p == "vps7") {$tarif = 32;$allopass = 30;}
if ($p == "vps8") {$tarif = 48;$allopass = 44;}
...
if ($p == "vps2013_68") {$tarif = 50;$allopass = 40;}
...
$paypalCrypt->addData('cert_id','5KKXYZKRPXPUA')
            ...
            ->addData('notify_url','https://www.gheberg.eu/zonemembre_paypal_renew_ipn.php')
...
<a href="zonemembre_prelevement.php?idd=<?php echo "$idd";?>">Choisissez le prélèvement automatique</a>
...
{
?>
Suite à la rarification des adresses ip, cette offre n'est plus disponible.<br>
Vous trouverez ici nos nouvelles offres : <a href="https://www.gheberg.eu/vps.html" target="_blank">www.gheberg.eu/vps.html</a>
<br><br>
Cependant, nous vous proposons d'upgrader votre compte sur l'offre <b>vps1</b>. Pour cela, cliquer ici : <u><a href="zonemembre_renew.php?idd=<?php echo $idd; ?>&upgrade=ok">UPGRADER mon compte</a></u>.<br>
Cette offre est facturée <b>3.5 € / mois ou 3 codes allopass</b>.
<br><br>
Plus d'information : <a href="http://www.gratuit-domaine.eu/phpBB3/viewtopic.php?f=21&t=8369" target="_blank">sur notre forum.</a>
<?php
}
?>
</center>
