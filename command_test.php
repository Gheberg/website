...
if ($p != "m1" and $p != "vps11" and $p != "vps1" and $p != "vps2" and $p != "vps3" and $p != "vps4" and $p != "vps5" and $p != "vps6" and $p != "vps7" and $p != "h1" and $p != "h2" and $p != "h3"  and $p != "sd1" and $p != "sd2" and $p != "sd3" and $p != "sd4" and $p != "sd5")
{
...
<form action="command2_test.php?p=<?php echo "$p";?>&info=<?php echo"$info";?>" method="post">
