...
$requete2=mysql_db_query($sql_bdd_vps,"select * from isoperso where vmid=\"$vmid\" order by id desc",$db_link_vps) or die(mysql_error());
if(mysql_num_rows($requete2)==0)
	...
	{
	$status=mysql_result($requete2,0,"etat");
	switch ($status)
	{
	case 1:
		echo"LOAD";
