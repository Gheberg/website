  	...
  	<div class="tail-bottom">
    	<div class="main">
      		...
      		<div id="content">		
				...
				<h6>Hors Forfait Téléphonique</h6>
				<br>
		
Vous pouvez débloquer votre hors forfait téléphonique afin de bénéficier des appels vers les mobiles, les numéros spéciaux et les appels internationnaux.<br>
Pour cela, vous devez nous retourner une autorisation de prélèvement bancaire. Dès reception, votre hors forfait sera débloqué. Vous recevrez une confirmation par e-mail.<br><br>
<center><a href="prelevement_tel.pdf" target="_blank"><img src="images/pdf-hf.png"></a></center>
                        <br class="clear" />
                    </div>
                </div>
            </div>	 
