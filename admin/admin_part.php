				...
				<div class="inner">
					...
					<ul class="dash">
						...
						<span class="bubble"><?php echo $hotline; ?></span>
							<a href="admin_part.php?action=hotline&hotline=<?php echo $hotline; ?>">
...
while($donnees = mysql_fetch_array($requete))
{
	...
	$referer = nl2br(stripslashes($donnees['referer']));
	$points = nl2br(stripslashes($donnees['points']));
	
	echo "<b>$jour</b> $points <a href=\"$referer\">$referer</a><br>";
}
?>
<br><a href="wywy.php?pseudo=<?php echo"$pseudo";?>" target="_blank">Supprimer les points</a>
					</table>
