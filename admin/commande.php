				...
				<div class="inner">
					...
					<ul class="dash">
						...
						<span class="bubble"><?php echo $hotline; ?></span>
							<a href="commande.php?action=hotline&hotline=<?php echo $hotline; ?>">
...
while ($donnees = mysql_fetch_array($reponse) )
{
	...
	if ($date != $date2) echo"<div style=\"height:10px;background-color:red;txt-align:center\"></div>";
	else echo"<hr>";
	...
	if ($info == "supp vps")
	{
		...
		echo "<form method=\"post\" action=\"admin_heberg.php?script=1&pseudo=$pseudo\"><font color=\"$color\"><b>$pseudo : $info $datem</b></font><input type=\"submit\" value=\"Valider\"></form>";
	}
	else echo "<form method=\"post\" action=\"admin_heberg.php?script=1&pseudo=$pseudo\"><font color=\"$color\"><b>$pseudo : $info ($date)</b></font><input type=\"submit\" value=\"Valider\"></form>";
}
?>
		  <hr />
