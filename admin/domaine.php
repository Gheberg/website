				...
				<div class="inner">
					...
					<ul class="dash">
						...
						<span class="bubble"><?php echo $hotline; ?></span>
							<a href="domaine.php?action=hotline&hotline=<?php echo $hotline; ?>">
...
$reponse = mysql_query("SELECT * FROM att_domaine ORDER BY ID");

while ($donnees = mysql_fetch_array($reponse) )
{
	$pseudo = nl2br(stripslashes($donnees['pseudo']));
	$domaine = nl2br(stripslashes($donnees['domaine']));
	echo "<tr><td width='30%'><b>$pseudo </b></td><td width='60%'>$domaine </td><td width='60%'><form method=\"post\" action=\"domaine.php?script=1&pseudo=$pseudo&domaine=$domaine\"><input type=\"submit\" value=\"Accepter\"></form></td></tr>";
}
?>
					</table>
