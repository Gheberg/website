...
Vous pouvez choisir le prélèvement automatique.<br>Votre produit sera ainsi renouveller automatiquement 10 jours avant sa date d'expiration.<br>
<br>Si vous souhaitez annulé un prélèvement automatique, il suffit de <a href="zonemembre_contact.php?idd=<?php echo "$idd";?>">contacter nos conseillers clientèles</a>.<br>
Dès réception de vos documents, vous recevrez un mail de confirmation pour l'activation du renouvellement automatique.
<br>
<br>
<center><a href="prelevement_renew.pdf" target="_blank"><img src="images/pdf-hf.png"></a></center>
                        <br class="clear" />
                    </div>
                </div>
            </div>	 
