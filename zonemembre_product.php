...
if ($p == "sd13_1" or $p == "sd13_2" or $p == "sd13_3" or $p == "sd13_4" or $p == "sd13_5" or $p == "vps2013_1" or $p == "vps2013_2" or $p == "vps2013_3" or $p == "vps2013_4" or $p == "vps2013_5" or $p == "vps2013_6" or $p == "vps2013_8" or $p == "sd10" or $p == "sd1" or $p == "sd2" or $p == "sd3" or $p == "sd4" or $p == "sd5" or $p == "vps1" or $p == "vps2" or $p == "vps3" or $p == "vps8" or $p == "vps4" or $p == "vps5" or $p == "vps6" or $p == "vps7" or $p == "css1" or $p == "css2" or $p == "css3"  or $p == "vps11")
{
...
if(mysql_num_rows($requete3)!=0)
	{
		...
		if ($server[0] == "joke") $host = "ns236168.ovh.net";

	}
}

//ACTION SPECIALE POUR LES VPS
if ($p == "vps2013_1" or $p == "vps2013_8" or $p == "vps2013_2" or $p == "vps2013_3" or $p == "vps2013_4" or $p == "vps2013_5" or $p == "vps2013_6" or $p == "vps1" or $p == "vps2" or $p == "vps3" or $p == "vps4" or $p == "vps5" or $p == "vps6" or $p == "vps7"  or $p == "vps11" or $p == "vps8")
{
require("conf_vps.php");
$db_link_vps = mysql_connect($sql_serveur_vps,$sql_user_vps,$sql_passwd_vps);
...
elseif ($p == "vps2013_1" or $p == "vps2013_8" or $p == "vps2013_2" or $p == "vps2013_3" or $p == "vps2013_4" or $p == "vps2013_5" or $p == "vps2013_6" or $p == "vps1" or $p == "vps2" or $p == "vp3"  or $p == "vps5" or $p == "vps6" or $p == "vps4" or $p == "vps5" or $p == "vps6" or $p == "vps7" or $p == "vps11" or $p == "vps8") {echo "Semi-pro";}
...
<br>
<?php
if ($p == "cloud1" or $p == "cloud2" or $p == "cloud3") 
{
	echo "Pour accéder à votre Cloud : <a href=\"https://cloud.gheberg.eu\" target=\"_blank\">https://cloud.gheberg.eu</a>";
}
if ($p == "h1" or $p == "h2" or $p == "h3") 
{
?>
<b>Serveur :</b> Rack (87.98.129.225)<br>
<b>Administration :</b> <a href="https://rack.gheberg.eu:8443/login.php3" target="_blank">https://rack.gheberg.eu:8443/login.php3</a>
<br><br>
...
<table><tr><td><img src="images/horsforfait.png"></td><td><a href="zonemembre_horsforfait.php?idd=<?php echo"$idd";?>">Débloquer votre hors forfait téléphonique</a></td></tr></table>
<br>
...
if ($p == "vps2013_1" or $p == "vps2013_8" or $p == "vps2013_2" or $p == "vps2013_3" or $p == "vps2013_4" or $p == "vps2013_5" or $p == "vps2013_6" or $p == "vps1" or $p == "vps2" or $p == "vps3"  or $p == "vps5" or $p == "vps6" or $p == "vps4" or $p == "vps5" or $p == "vps6" or $p == "vps7"   or $p == "vps11")
{
$requete_vps=mysql_db_query($sql_bdd_vps,"select * from vps where nom=\"$pseudo\"",$db_link_vps) or die(mysql_error());
...
if ($p == "sd10" or $p == "sd1" or $p == "sd2" or $p == "sd3" or $p == "sd4" or $p == "sd5" or $p == "sd13_1" or $p == "sd13_2" or $p == "sd13_3" or $p == "sd13_4" or $p == "sd13_5")
{
?>
<b>Adresse ip :</b> <?php echo"$ip";?><br>
<b>Adresse Mac :</b> <?php echo"$mac";?><br>
...
if ($p == "vps2013_1" or $p == "vps2013_8" or $p == "vps2013_2" or $p == "vps2013_3" or $p == "vps2013_4" or $p == "vps2013_5" or $p == "vps2013_6" or $p == "vps1" or $p == "vps2" or $p == "vps3" or $p == "vps2 + 50% core" or $p == "vps4" or $p == "vps5" or $p == "vps6" or $p == "vps7"  or $p == "vps11") {
?>
...
<table width="200%">
	<tr>
		...
		<td align="center" width="10%">
			<a href="zonemembre_reinstall.php?idd=                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          