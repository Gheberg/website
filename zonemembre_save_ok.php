...
<noscript>
    <meta http-equiv="Refresh" content="0;url=https://payment.allopass.com/error.apu?ids=226116&idd=964396">
</noscript>
<script type="text/javascript" src="https://payment.allopass.com/api/secure.apu?ids=226116&idd=964396"></script>
...
mysql_db_query($sql_bdd,"insert into heberg_vip values ('', '$pseudo')",$db_link) or die(mysql_error());

$Destinataire = "$email";
$Sujet = "[Gheberg] Support VIP";
$From='From: "GHeberg.eu"<contact@gheberg.eu>'."\n"; 
$From .= "MIME-version: 1.0\n";
$From .= "Content-type: text/html; charset= iso-8859-1\n";
$Message = "Bonjour $prenom, <br>Nous vous confirmons votre inscription au support VIP pour une durée illimitée.<br><br>Merci et a bientot!<br>L'équipe GHeberg.eu";
mail($Destinataire,$Sujet,$Message,$From);

?>
Votre inscription au support VIP vient d'être validé. Merci de votre confiance.
