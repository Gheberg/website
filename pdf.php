...
$info=mysql_result($requete2,0,"info");
$date=mysql_result($requete2,0,"date");

$testinfo = explode(' ', $info);
if ($testinfo[0] == "Renew") $type = "Allopass";
else $type = "Paypal";
...
<page backcolor=\"#FEFEFE\" backimg=\"./res/bas_page.png\" backimgx=\"center\" backimgy=\"bottom\" backimgw=\"100%\" backtop=\"0\" backbottom=\"30mm\" footer=\"date;heure;page\" style=\"font-size: 12pt\">
	...
	<div style=\"width:100%;position:relative;\">
		<div style=\"position:absolute;height:25px;width:60%;border:1px solid black;padding-top:6px;text-align:center\">$info</div>
