...
$test = "1";
  ...
  $AUTH = urlencode( "226116/894653/2083861" );
...
mysql_db_query($sql_bdd,"insert into heberg_log values ('', '$pseudo', '$date2 $heure', '$ip', 'Hébergement ($RECALL)', '$idd')",$db_link) or die(mysql_error());
